...
require (
	github.com/nickwells/check.mod/v2 v2.1.25
	github.com/nickwells/english.mod v1.2.5
	github.com/nickwells/filecheck.mod v1.2.9
	github.com/nickwells/location.mod v1.2.34
	github.com/nickwells/macros.mod v1.1.10
	...
	github.com/nickwells/versionparams.mod v1.2.18
)
