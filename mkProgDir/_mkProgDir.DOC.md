...
The intention of the `param` package is to allow the user to set various
configurable parameters, to check that all the values are allowable and to
provide complete documentation for the program from the command line.
